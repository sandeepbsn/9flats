...
function TopCities() {
    return (
        <div className="container top-cities mb-5 mt-3" >
            ...
            <div className="row">
                <div className="col-6 col-md-3 mb-4 top-city" id="tc-berlin-germany" role="tabpanel">
                ...
                <div className="col-6 col-md-3 mb-4 top-city" id="tc-amsterdam-netherlands" role="tabpanel">
                    <div className="rounded border z-depth-1 overflow-hidden">
                ...
                <div className="col-6 col-md-3 mb-4 top-city" id="tc-london-united_kingdom" role="tabpanel">
                    <div className="rounded border z-depth-1 overflow-hidden">
                ...
                <div className="col-6 col-md-3 mb-4 top-city" id="tc-brussels-belgium" role="tabpanel">
                    <div className="rounded border z-depth-1 overflow-hidden">
                ...
                <div className="col-6 col-md-3 mb-4 top-city" id="tc-dubai-united_arab_emirates" role="tabpanel">
                    <div className="rounded border z-depth-1 overflow-hidden">
                ...
                <div className="col-6 col-md-3 mb-4 top-city" id="tc-barcelona-spain" role="tabpanel">
                    <div className="rounded border z-depth-1 overflow-hidden">
                ...
                <div className="col-6 col-md-3 mb-4 top-city" id="tc-munich-germany" role="tabpanel">
                    <div className="rounded border z-depth-1 overflow-hidden">
                ...
                <div className="col-6 col-md-3 mb-4 top-city" id="tc-paris-france" role="tabpanel">
                    <div className="rounded border z-depth-1 overflow-hidden">
                        <a href="/paris-france">
                            <div className="image lazy"
                ...
                <div className="col-6 col-md-3 mb-4 top-city" id="tc-madrid-spain" role="tabpanel">
                    <div className="rounded border z-depth-1 overflow-hidden">
                        <a href="/madrid-spain">
                            <div className="image lazy"
                ...
                <div className="col-6 col-md-3 mb-4 top-city" id="tc-new_york_city-new_york" role="tabpanel">
                    <div className="rounded border z-depth-1 overflow-hidden">
                ...
                <div className="col-6 col-md-3 mb-4 top-city" id="tc-vienna-austria" role="tabpanel">
                    <div className="rounded border z-depth-1 overflow-hidden">
                ...
                <div className="col-6 col-md-3 mb-4 top-city" id="tc-miami-florida" role="tabpanel">
                    <div className="rounded border z-depth-1 overflow-hidden">
