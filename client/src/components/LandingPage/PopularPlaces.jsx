      ...
      <div>
        <div className="container-fluid">
          ...
          <div className="container mt-5 mb-5">
            ...
            <div className=" poplaces__list__w row lazy bgImage" data-bg="url(//assets.9flats.com/assets/cities/map-6e2eb5adb75351fa903efbfc4269396aa21692ee496bf399a35f8f03dda2cea1.png)" data-was-processed="true"
            >
